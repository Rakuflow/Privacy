...
mod tests {
    ...
    use snforge_std::{ContractClassTrait, declare, deploy_syscall};
    ...
    fn test_verifier_deploy_and_verify() {
        ...
        let (verifier_address, _) = deploy_syscall(class_hash, 0, calldata.span(), false)
            .unwrap_syscall();
        ...
        public_inputs.append(2);
        public_inputs.append(3);
        public_inputs.append(4);
        ...
        withdraw_public.append(1);
        withdraw_public.append(2);
        withdraw_public.append(3);
        withdraw_public.append(4);
        withdraw_public.append(5);
