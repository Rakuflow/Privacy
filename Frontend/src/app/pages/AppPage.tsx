                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-amber-200/80">
                      Generate your zk-keypair to start using shielded transactions. This only takes one click!
                    </p>
                  </div>
            ...
            <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <GlassCard className="p-3 sm:p-4">
                ...
                <div className="flex items-center justify-between gap-2">
                  <p className="font-mono text-xs sm:text-sm truncate">{address.slice(0, 10)}...{address.slice(-8)}</p>
                  <button
              ...
              <GlassCard className="p-3 sm:p-4">
                ...
                <div className="flex items-center justify-between gap-2">
                  {isReady ? (
                    <>
                      <p className="font-mono text-xs sm:text-sm text-violet-400 truncate">{zkAddress.slice(0, 10)}...{zkAddress.slice(-8)}</p>
                      <button
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                <div className="flex-1">
                  ...
                  <p className="text-xl sm:text-2xl font-bold">
                    {balanceLoading ? "Loading..." : `${formatBalance(balance)} STRK`}
                  </p>
