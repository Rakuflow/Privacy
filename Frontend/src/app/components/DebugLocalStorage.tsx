  ...
  if (!showDebug) {
    return (
      <Button
        ...
        className="fixed bottom-4 right-4 bg-black/50 border-white/20 hover:bg-black/70 text-white z-50"
      >
        ...
        {Object.keys(storageData).length === 0 ? (
          ...
          Object.entries(storageData).map(([key, value]) => (
            <div key={key} className="p-2 bg-white/5 rounded border border-white/10">
              <div className="font-semibold text-violet-300 mb-1 break-all">
