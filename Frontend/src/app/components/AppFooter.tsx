      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          ...
          <div>
            <div className="flex items-center gap- mb-4">
              <img
                ...
                alt="RakuShield Logo"
                className="w-5 h-5 sm:w-7 sm:h-7 rounded-2xl"
              />
            ...
            <p className="text-sm text-gray-400 leading-relaxed mb-4">
              Privacy-first transfers on Starknet using zero-knowledge proofs.
              Keep your transactions private and secure.
            </p>
        ...
        <div className="border-t border-white/10 mt-8 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500 text-center sm:text-left">
            © {currentYear} RakuShield. Built with privacy in mind on Starknet.
            • Privacy Policy
          </p>
        </div>
      </div>
