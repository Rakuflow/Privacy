    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-[calc(100%-2rem)] sm:max-w-2xl bg-gray-900/95 backdrop-blur-xl border-white/10 max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-400">Generate your zero-knowledge keypair for private transactions</DialogDescription>
        </DialogHeader>
          ...
          {!generated ? (
            <>
              ...
              <div className="p-4 bg-violet-500/10 border border-violet-500/20 rounded-lg space-y-3">
                ...
                <ul className="text-xs text-gray-300 space-y-2 ml-6 list-disc">
                  ...
                  <li>
                    Your spending key is <strong className="text-violet-300">securely stored</strong> in your browser (encoded)
                  </li>
              ...
              <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-lg flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-200/80">
                    Your spending key is stored encoded in your browser for convenience. Your wallet signature can always re-derive the same key. For maximum security, you can clear stored keys from
              ...
              {/* Generate Button */}
              <GlowButton className="w-full" onClick={handleGenerateKeypair} disabled={loading || !account}>
                {loading ? (
                  <>
            ...
            <>
              ...
              <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                ...
                <p className="text-xs text-green-200/80">Your shielded keypair is ready. You can now deposit, transfer, and withdraw privately.</p>
              </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="p-4 bg-gradient-to-r from-violet-500/20 to-indigo-500/20 border border-violet-500/30 rounded-lg">
                    <div className="flex items-center justify-between gap-3">
                      <p className="font-mono text-sm text-violet-300 break-all flex-1">{zkAddress}</p>
                ...
                <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                  <p className="text-xs text-blue-200/80">
                    💡 <strong>Share this 0zk... address</strong> with others to receive private transfers. This is your shielded account, separate from your public wallet (0x...).
                  </p>
                </div>
              </div>
              ...
              <details className="group">
                <summary className="text-sm text-gray-400 cursor-pointer hover:text-violet-300 transition-colors">🔍 Technical Details (Advanced)</summary>
